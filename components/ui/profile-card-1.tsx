...
import { Globe, Mail, Link, ArrowUpRight } from "lucide-react";
...
const ProfileCardDemo = () => {
  const cardProps: GlassmorphismProfileCardProps = {
    ...
    socialLinks: [
      { id: "portfolio", icon: Globe, label: "Portfolio", href: "#" },
      { id: "mail", icon: Mail, label: "Email", href: "#" },
      { id: "website", icon: Link, label: "Website", href: "#" },
    ],
    actionButton: {
      text: "Contact Me",
      href: "#",
...
const SocialButton = ({ item, setHoveredItem, hoveredItem }: SocialButtonProps) => (
...
const ActionButton = ({ action }: ActionButtonComponentProps) => (
  <a
    href={action.href}
    onClick={(e) => e.preventDefault()}
...
const Tooltip = ({ item, hoveredItem }: TooltipProps) => (
  <div
    role="tooltip"
