...
async def analyze(
    ...
    try:
        pipeline_fn = run_pipeline_with_api_key if x_gemini_api_key else run_pipeline
        pipeline_args = (image_bytes, media_type, x_gemini_api_key) if x_gemini_api_key else (image_bytes, media_type)
